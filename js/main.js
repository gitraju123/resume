...
const FALLBACK_DATA = {"personal":{"name":"Alex Johnson","title":"Software Engineer","roles":["Software Engineer","Full Stack Developer","Backend Developer","DevOps Engineer"],"bio":"A passionate software engineer with experience building scalable web applications and cloud infrastructure. Skilled in designing clean, maintainable systems and delivering great user experiences.","birthDate":"","email":"alex@example.com","phone":"","address":"Your City, Country","languages":["English"],"linkedin":"https://www.linkedin.com/in/your-profile","github":"https://github.com/your-username","twitter":"","cvUrl":"","profileImage":"","expSummary":"3+ Years in Software Engineering","availability":"Open to Opportunities"},"stats":[{"label":"Years Experience","value":"3+","icon":"fas fa-briefcase"},{"label":"Projects Completed","value":"12+","icon":"fas fa-project-diagram"},{"label":"Technologies","value":"20+","icon":"fas fa-code"}],"skills":[{"category":"Frontend","icon":"fas fa-laptop-code","items":[{"name":"HTML/CSS","level":90},{"name":"JavaScript","level":80},{"name":"React","level":75}]},{"category":"Backend","icon":"fas fa-server","items":[{"name":"Node.js","level":75},{"name":"Python","level":70},{"name":"SQL","level":65}]},{"category":"DevOps & Tools","icon":"fas fa-tools","items":[{"name":"Git","level":85},{"name":"Docker","level":70},{"name":"AWS","level":65},{"name":"CI/CD","level":70}]}],"experience":[{"id":1,"company":"Example Corp","role":"Software Engineer","type":"Full-time","startDate":"Jan 2023","endDate":"Present","current":true,"description":"Building and maintaining scalable web applications and APIs.","responsibilities":["Designed and implemented RESTful APIs used by 10k+ users","Led frontend migration from vanilla JS to React","Reduced CI/CD pipeline runtime by 40% through parallelisation","Mentored 2 junior developers"],"technologies":["React","Node.js","AWS","Docker","PostgreSQL"]},{"id":2,"company":"Startup XYZ","role":"Junior Developer","type":"Full-time","startDate":"Jun 2021","endDate":"Dec 2022","current":false,"description":"Contributed to full-stack development of the core product.","responsibilities":["Built reusable UI components in React","Integrated third-party payment APIs","Wrote unit and integration tests with Jest"],"technologies":["React","Python","Django","MySQL"]}],"education":[{"id":1,"institution":"State University","degree":"B.Sc.","field":"Computer Science","startYear":"2017","endYear":"2021","grade":"GPA: 3.8"}],"projects":[{"id":1,"title":"Open Source Dashboard","category":"Web","description":"A real-time analytics dashboard built with React and WebSockets, displaying live metrics from multiple data sources.","details":"Designed a modular plugin system so teams can add custom widgets without changing core code.","technologies":["React","Node.js","WebSockets","Chart.js","Docker"],"image":"","github":"https://github.com/your-username/dashboard","demo":"","featured":true,"highlights":["Real-time data streaming","Plugin-based widget system","Dockerised for easy deployment","50+ GitHub stars"]},{"id":2,"title":"CLI Deployment Tool","category":"DevOps","description":"A command-line tool that automates cloud deployments across AWS and GCP with a single config file.","details":"Supports rollback, blue/green deployments and Slack notifications.","technologies":["Python","AWS","GCP","Terraform","Shell Script"],"image":"","github":"","demo":"","featured":true,"highlights":["Multi-cloud support","One-command rollback","Slack integration","Used by 3 internal teams"]}],"certificates":[{"id":1,"title":"AWS Certified Developer – Associate","issuer":"Amazon Web Services","date":"2023","image":"","credentialUrl":""},{"id":2,"title":"Google Associate Cloud Engineer","issuer":"Google Cloud","date":"2022","image":"","credentialUrl":""}],"contact":{"address":"Your City, Country","email":"alex@example.com","phone":"","availability":"Open to exciting new opportunities"},"meta":{"siteTitle":"Alex Johnson — Software Engineer","siteDescription":"Portfolio of Alex Johnson, a software engineer specialising in full-stack web development and cloud infrastructure.","keywords":"software engineer, full stack, react, node.js, aws, devops","githubOwner":"your-github-username","githubRepo":"your-repo-name","siteUrl":"https://your-github-username.github.io/your-repo-name/","maintenance":false}};
...
function renderHero(data) {
  ...
  // Also update loader logo, about section monogram and footer
  const loaderLogo = document.getElementById('loader-logo');
  if (loaderLogo) loaderLogo.textContent = initials;
  const aboutInitials = document.getElementById('about-initials');
  if (aboutInitials) aboutInitials.textContent = initials;
...
function renderContact(data) {
  ...
  if (p.linkedin) {
    ...
    const liVal = document.getElementById('contact-linkedin-val');
    if (liVal) liVal.textContent = p.linkedin.replace(/^https?:\/\//,'');
  }
...
function renderFooter(data) {
  ...
  // Update only the initials span, preserving the bracket structure
  const footerInitials = document.getElementById('footer-initials');
  if (footerInitials) {
    const initials = (data.personal.name || '').split(' ').filter(Boolean).map(w => w[0]).join('').slice(0,2).toUpperCase() || '?';
    footerInitials.textContent = initials;
  }
